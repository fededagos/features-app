    ...
    return [
        ...
        html.Details(
            [
                ...
                html.Br(),
                html.Div([html.Img(src=opto_plots_url, className="responsive",),]),
            ]
        ),
        html.Hr(),
        html.Details(
            [
                ...
                html.Br(),
                html.P(
                    "Note: formatting in the embedded Google Sheet may be off. \
                    If this is the case, just switch blocker sheet tabs back and fort or click on another point to fix it. \
                    Alternatively, you can open the sheet in a new browser tab by clicking on the corresponding links."
                ),
                html.Div(
                    [
                        html.Iframe(
