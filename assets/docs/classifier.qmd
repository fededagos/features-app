...
The key outcome of the C4 collaboration is the development of a robust classifier to predict cerebellar neuron types based on spike-sorted data. The classifier is released as part of [`NeuroPyxels`](https://github.com/m-beau/NeuroPyxels), a generalist Python package to analyze Neuropixels recordings.
